...
var cases = []struct {
	...
	{"Edit Status By Operator",
		...
		admission.Update,
		userIsOperator(),
		editStatus(getSampleDormantDatabase()),
		getSampleDormantDatabase(),
		false,
		true,
	},
	...
	{"Edit Spec.Origin By User",
		...
		admission.Update,
		userIsHooman(),
		editSpecOrigin(getSampleDormantDatabase()),
		getSampleDormantDatabase(),
		false,
		false,
	},
	{"Edit Spec.Resume By Operator",
		...
		admission.Update,
		userIsOperator(),
		editSpecResume(getSampleDormantDatabase()),
		getSampleDormantDatabase(),
		false,
		true,
	},
	...
	{"Edit Spec.WipeOut By Operator",
		...
		admission.Update,
		userIsOperator(),
		editSpecWipeOut(getSampleDormantDatabase()),
		getSampleDormantDatabase(),
		false,
		true,
	},
	...
	{"Delete With Wiping By User",
		...
		admission.Delete,
		userIsHooman(),
		editStatusWipedOut(getSampleDormantDatabase()),
		api.DormantDatabase{},
		true,
		true,
	},
...
func getSampleDormantDatabase() api.DormantDatabase {
